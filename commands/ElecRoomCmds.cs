...
namespace JPMorrow.UI.ViewModels
{
    public partial class ParentViewModel
    {
        public void AddElecRoom(Window window)
        {
            ...
            {
                debugger.show(header: "Add Elec Room", err: ex.Message);
            }
        }
        ...
        public void RemoveElecRoom(Window window)
        {
            ...
            {
                debugger.show(header: "Remove Elec Room", err: ex.Message);
            }
        }
        ...
        public void SelectRoom(Window window)
        {
            ...
            {
                debugger.show(header: "Select Room", err: ex.Message);
            }
        }
        ...
        public void AddUnistrut(Window window)
        {
            ...
            {
                debugger.show(header: "Add Unistrut", err: ex.Message);
            }
        }
        ...
        public void RemoveUnistrut(Window window)
        {
            ...
            {
                debugger.show(header: "Remove Unistrut", err: ex.Message);
            }
        }
        ...
        public void AddGrdBar(Window window)
        {
            ...
            {
                debugger.show(header: "Add Ground Bar", err: ex.Message);
            }
        }
        ...
        public void RemoveGrdBar(Window window)
        {
            ...
            {
                debugger.show(header: "Remove Ground Bar", err: ex.Message);
            }
        }
        ...
        public void AddPanelBacking(Window window)
        {
            ...
            {
                debugger.show(header: "Add Panel Backing", err: ex.Message);
            }
        }
        ...
        public void RemovePanelBacking(Window window)
        {
            ...
            {
                debugger.show(header: "Remove Panel Backing", err: ex.Message);
            }
        }
        ...
        public void AddPanelboard(Window window)
        {
            ...
            {
                debugger.show(header: "Add Panelboard", err: ex.Message);
            }
        }
        ...
        public void RemovePanelboard(Window window)
        {
            ...
            {
                debugger.show(header: "Remove Panelboard", err: ex.Message);
            }
        }
        ...
        public void GetElecRoomConduit(Window window)
        {
            ...
            {
                debugger.show(header: "Get Elec Room Conduit", err: ex.Message);
            }
        }
        ...
        public void ClearElecRoomConduit(Window window)
        {
            ...
            {
                debugger.show(header: "Clear Elec Room Conduit", err: ex.Message);
            }
        }
    }
}
