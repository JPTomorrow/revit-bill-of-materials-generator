...
public static class ConduitLINQ
{
    ...
    public static bool GetNextRackedConduits(
        ...
        View3D view, IEnumerable<BuiltInCategory> clash_categories,
        IEnumerable<BuiltInCategory> conduit_categories,
        out List<Element> next_racked_conduits, double chk_dist = -1)
    {
